...
public class ServletModifProfil extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("bouton").equals("modif")) {
			...
			if (MapErreurs.isEmpty()) {
				...
				EnchereManager.getInstance().modifUtilisateur(utilisateurSession.getNoUtilisateur(), pseudo, nom,
						prenom, email, telephone, rue, codePostal, ville, confirmation);
		...
		if (request.getParameter("bouton").equals("suppr")) {
			...
			// Vérification mot de passe avec le pseudo d'utilisateurSession
						...
						if (MapErreurs.isEmpty()) {
							...
							session.invalidate();
							response.sendRedirect("./SuppressionProfil");
						}else {
